...
# Filtra as vendas realizadas em Formiga ou em Arcos com operador |
dados_vendas_limpos |> 
...
# Cria a variável receita total, agrupa por cidade, calcula a receita
# total por cidade e ordena o resultado
dados_vendas_limpos |> 
  mutate(receita_total = unidades * preco_unitario) |> 
  group_by(cidade) |> 
