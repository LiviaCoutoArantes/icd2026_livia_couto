...
# Quando o nome da coluna traz duas informações
...
# Combinando vendas_produtos e clientes
...
# Desafio: Combine a 3 tabelas com um único pipeline usando left_join()
